...
class TestCases:
    ...
    def test_bild3_Insert_strings_in_the_fields_First_and_Second_Number_(self):
        ...
        time.sleep(2)
        drop_down_name.select_by_value("3")  # select item by id - Bild 3
        time.sleep(2)
    ...
    def test_bild3_option_integers_only(self):
    ...
    def test_bild3_concatenate(self):
    ...
    def test_bild3_add_insert_numbers_(self):
    ...
    def test_bild3_button_clear(self):
    ...
    def test_bild3_subtract_insert_numbers(self):
    ...
    def test_bild3_multiply_insert_numbers_(self):
    ...
    def test_bild3_Divide_insert_numbers_(self):
    ...
    def test_bild3_Divide_by_zero(self):
