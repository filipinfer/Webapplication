...
class TestCases:
    ...
    def test_bild1_Insert_strings_in_the_fields_First_and_Second_Number_(self):
        ...
        time.sleep(2)
        drop_down_name.select_by_value("6")  # select item by id - Bild 6
        time.sleep(2)
        first_number = self.driver.find_element(by=By.NAME, value="number1")
        first_number.send_keys("ouj")  # tested with both string and numbers
        time.sleep(2)
        second_number = self.driver.find_element(by=By.NAME, value="number2")
        second_number.send_keys("test")  # tested with both string and numbers
        time.sleep(2)
    ...
    def test_bild6_option_integers_only(self):
    ...
    def test_bild6_add_insert_numbers_(self):
    ...
    def test_bild6_button_clear(self):
    ...
    def test_bild6_subtract_insert_numbers(self):
    ...
    def test_bild6_multiply_insert_numbers_(self):
    ...
    def test_bild6_Divide_insert_numbers_(self):
    ...
    def test_bild6_Divide_by_zero(self):
