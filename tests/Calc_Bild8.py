...
class TestCases:
    ...
    def test_bild8_Insert_strings_in_the_fields_First_and_Second_Number(self):
        ...
        second_number.send_keys("9")  # tested with both string and numbers
        time.sleep(2)
    ...
    def test_bild8_option_integers_only(self):
    ...
    def test_bild8_concatenate(self):
    ...
    def test_bild8_add_insert_numbers_(self):
    ...
    def test_bild8_button_clear(self):
    ...
    def test_bild8_subtract_insert_numbers(self):
    ...
    def test_bild8_multiply_insert_numbers_(self):
    ...
    def test_bild8_Divide_insert_numbers_(self):
    ...
    def test_bild8_Divide_by_zero(self):
