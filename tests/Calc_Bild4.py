...
class TestCases:
    ...
    def test_bild4_Insert_strings_in_the_fields_First_and_Second_Number_(self):
        ...
        time.sleep(2)
        drop_down_name.select_by_value("4")  # select item by id - Bild 4
        time.sleep(2)
    ...
    def test_bild4_option_integers_only(self):
    ...
    def test_bild4_concatenate(self):
    ...
    def test_bild4_add_insert_numbers_(self):
    ...
    def test_bild4_button_clear(self):
    ...
    def test_bild4_subtract_insert_numbers(self):
    ...
    def test_bild4_multiply_insert_numbers_(self):
    ...
    def test_bild4_Divide_insert_numbers_(self):
    ...
    def test_bild4_Divide_by_zero(self):
