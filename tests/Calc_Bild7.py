...
class TestCases:
    ...
    def test_bild7_Insert_strings_in_the_fields_First_and_Second_Number_(self):

        """ Function "Add" - insert strings, an error message should be displayed"""

        drop_down_name = Select(self.driver.find_element(by=By.ID, value="selectBuild"))
        time.sleep(2)
        drop_down_name.select_by_value("7")  # select item by id - Bild 7
        time.sleep(2)
        first_number = self.driver.find_element(by=By.NAME, value="number1")
        first_number.send_keys("test")  # tested with both string and numbers
        time.sleep(2)
        second_number = self.driver.find_element(by=By.NAME, value="number2")
        second_number.send_keys("654")  # tested with both string and numbers
        time.sleep(2)
    ...
    def test_bild7_option_integers_only(self):

        """ The system should display only integers numbers when click on 'integers only' """

        drop_down_name = Select(self.driver.find_element(by=By.ID, value="selectBuild"))
        time.sleep(2)
        drop_down_name.select_by_value("8")  # select item by id - Bild 8
        time.sleep(2)
        first_number = self.driver.find_element(by=By.NAME, value="number1")
    ...
    def test_bild6_concatenate(self):
    ...
    def test_bild7_add_insert_numbers_(self):
    ...
    def test_bild7_button_clear(self):
    ...
    def test_bild7_subtract_insert_numbers(self):
    ...
    def test_bild7_multiply_insert_numbers_(self):
    ...
    def test_bild7_Divide_insert_numbers_(self):
    ...
    def test_bild7_Divide_by_zero(self):
