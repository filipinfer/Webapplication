...
class TestCases:
    ...
    def test_bild2_Insert_strings_in_the_fields_First_and_Second_Number_(self):
        ...
        time.sleep(2)
        drop_down_name.select_by_value("2")  # select item by id - Bild 2
        time.sleep(2)
    ...
    def test_bild2_option_integers_only(self):

        """ The system should display only integers numbers when click on 'integers only' """

        drop_down_name = Select(self.driver.find_element(by=By.ID, value="selectBuild"))
        time.sleep(2)
        drop_down_name.select_by_value("2")  # select item by id - Bild 1
        time.sleep(2)
        first_number = self.driver.find_element(by=By.NAME, value="number1")
    ...
    def test_bild2_concatenate(self):
    ...
    def test_bild2_add_insert_numbers_(self):
    ...
    def test_bild2_button_clear(self):
    ...
    def test_bild2_subtract_insert_numbers(self):
    ...
    def test_bild2_multiply_insert_numbers_(self):
    ...
    def test_bild2_Divide_insert_numbers_(self):
    ...
    def test_bild2_Divide_by_zero(self):
